...
export class Transaction {
  ...
  public prepareProxy (userAddress: string, networkAddress: string): Promise<any> {
    return this.getTxInfos(userAddress)
      .then(txinfos => {
        ...
        return lightwallet.txutils.createContractTx(userAddress.substring(2, userAddress.length), txOptions)
      })
  }
