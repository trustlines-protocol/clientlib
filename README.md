...
**NOTE: The [trustlines-network contracts](https://github.com/trustlines-network/contracts) are deployed on the (_Trustlines_) [Laika testnet](https://blockexplorer.trustlines.foundation/). Some Laika test `TLC` is therefore required to interact with the contracts in this setup.**
